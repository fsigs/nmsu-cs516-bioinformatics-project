...
When putting the K-mers in the *BLASTN* database, no significant information was found. We had an expert look at the differences in frequent 15-mers between the RNA viruses. he said it might speak to their Phylogenetic differences and where the SARS originated from.  However, this might be due to the stronger mutation rate of SARS-CoV-2 virus.
