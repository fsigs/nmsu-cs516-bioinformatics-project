...
When putting the Kmers in the blastn database, no significant similarities where found.  In other words there wasn't much alignment.  The differences in frequent 15mers between the RNA viruses might speak to their Phylogenetic differences and where it originated from. 
