...
When putting the K-mers in the *BLASTN* database, no significant similarities where found. In other words, there was not much alignment. The differences in frequent 15-mers between the RNA viruses might speak to their Phylogenetic differences and where the SARS originated from. 
