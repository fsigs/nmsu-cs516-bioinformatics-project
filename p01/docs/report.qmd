...
When putting the K-mers in the *BLASTN* database, no significant information was found. We had an expert look at the differences in frequent 15-mers between the RNA viruses. He said it might speak to their Phylogenetic differences and where the SARS originated from.  However, the more frequent k-mers in SARS-CoV-2 might be due to the stronger evoloution mutation of the virus. Later on in task E6, we found that SARS-CoV and SARS-CoV have a 100% coincidence and only have minor differences in mutation. 
